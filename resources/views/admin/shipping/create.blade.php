    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('admin.add_shipping') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('admin.home') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('admin.add_shipping') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-secondary">
                            ...
                            <form method="post" action="{{ route('shipping.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">{{ __('admin.add_shipping_company') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
