                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.shipping') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.shipping_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('shipping.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_shipping') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($shippings as $shipping)
                                        <tr>
                                            ...
                                            <td class="id">{{ $shipping->id }}</td>
                                            <td>{{ $shipping->{'name_' . LaravelLocalization::getCurrentLocale()} }}</td>
    ...
    <script>
        ...
        $(document).ready(
            ...
            $('#delete_selected').click(function(){
                ...
                $.ajax({
                    method: 'post',
                    url: '{{ route('shipping.delete.post') }}',
                    data: {
                        'ids': id,
                        '_token': '{{ csrf_token() }}',
                    },
