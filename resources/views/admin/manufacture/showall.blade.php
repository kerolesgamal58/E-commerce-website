                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.manufacture') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.manufacture_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('manufacture.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_manufacture') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($manufactures as $manufacture)
                                        <tr>
                                            ...
                                            <td class="id">{{ $manufacture->id }}</td>
                                            <td>{{ $manufacture->{'name_' . LaravelLocalization::getCurrentLocale()} }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('manufacture.delete', $manufacture->id) }}">
                                                    <i class="fas fa-user-minus"></i>
                                                </a>
                                            </td>
                                        </tr>
    ...
    <script>
        ...
        $(document).ready(
            ...
            $('#delete_selected').click(function(){
                ...
                $.ajax({
                    method: 'post',
                    url: '{{ route('manufacture.delete.post') }}',
                    data: {
                        'ids': id,
                        '_token': '{{ csrf_token() }}',
                    },
