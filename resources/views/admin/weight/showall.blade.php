                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.weight') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.weight_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('weight.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_weight') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($weights as $weight)
                                        <tr>
                                            ...
                                            <td class="id">{{ $weight->id }}</td>
                                            <td>{{ $weight->name_ar }}</td>
                                            <td>{{ $weight->name_en }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('weight.delete', $weight->id) }}">
                                                    <i class="fas fa-user-minus"></i>
                                                </a>
                                            </td>
                                        </tr>
