                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.country_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('country.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_country') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($countries as $country)
                                        <tr>
                                            ...
                                            <td>{{ $country->code }}</td>
                                            <td><img src="{{ asset('storage/' . $country->logo) }}" alt="{{ $country->name. ' logo' }}"
