                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.mall') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.mall_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('mall.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_mall') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($malls as $mall)
                                        <tr>
                                            ...
                                            <td class="id">{{ $mall->id }}</td>
                                            <td>{{ $mall->{'name_'.LaravelLocalization::getCurrentLocale()} }}</td>
                                            <td>{{ $mall->contact_name }}</td>
                                            <td>{{ $mall->mobile }}</td>
                                            <td>{{ $mall->email }}</td>
                                            <td>
                                                <a href="{{ route('mall.edit', $mall->id) }}">
                                                    <i class="fa fa-user-edit"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('mall.delete', $mall->id) }}">
                                                    <i class="fas fa-user-minus"></i>
                                                </a>
                                            </td>
                                        </tr>
