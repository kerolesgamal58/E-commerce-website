                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.product') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.product_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('storage/'.$product->main_image ) }}"
                                                     alt="{{ $product->title.' image' }}" style="width: 50px; height: 50px;">
                                            </td>
                                            <td>{{ $product->stock }}</td>
                                            <td>{{ $product->price }}</td>
