                            ...
                            <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        @include('admin.product.taps.product_info')
                                        @include('admin.product.taps.department')
                                        @include('admin.product.taps.product_settings')
                                        @include('admin.product.taps.product_media')
                                        @include('admin.product.taps.product_size_weight')
                                        @include('admin.product.taps.other_data')
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#jstree').jstree({
                "core" : {
                    'data' : {!! \App\Helper\load_dep( old('department_id') ) !!},
                    "themes" : {
                        "variant" : "large"
                    }
                },
