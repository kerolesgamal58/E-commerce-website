                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.color') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.color_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('color.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_color') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($colors as $color)
                                        <tr>
                                            ...
                                            <td>{{ $color->name_en }}</td>
                                            <td>
                                                <span style="border-radius: 4px; background-color: {{$color->color}}; display: block; width: 50px; height: 50px;"></span>
                                            </td>
