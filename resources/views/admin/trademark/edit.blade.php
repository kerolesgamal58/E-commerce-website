    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('admin.edit_trademark') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('admin.home') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('admin.edit_trademark') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card card-secondary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="post" action="{{ route('trademark.update', $trademark->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!is_null($trademark->logo))
                                            <img src="{{ asset('storage/' . $trademark->logo) }}" alt="logo" style="height: 50px; height: 50px; margin-bottom: 5px">
                                        @endif
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">{{ __('admin.edit_trademark') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
