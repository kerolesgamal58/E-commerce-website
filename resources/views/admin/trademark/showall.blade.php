                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('admin.trademark') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('admin.trademark_control') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('trademark.create') }}" class="btn btn-primary mb-4">
                                    {{ __('admin.add_new_trademark') }}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach($trademarks as $trademark)
                                        <tr>
                                            ...
                                            <td class="id">{{ $trademark->id }}</td>
                                            <td>{{ $trademark->{'name_' . LaravelLocalization::getCurrentLocale()} }}</td>
                                            <td>
                                            @if(!is_null($trademark->logo))
                                                <img src="{{ asset('storage/' . $trademark->logo) }}" alt="{{ ' logo' }}"
                                            ...
                                            <td>
                                                <a href="{{ route('trademark.edit', $trademark->id) }}">
                                                    <i class="fa fa-user-edit"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('trademark.delete', $trademark->id) }}">
                                                    <i class="fas fa-user-minus"></i>
                                                </a>
                                            </td>
                                        </tr>
    ...
    <script>
        ...
        $(document).ready(
            ...
            $('#delete_selected').click(function(){
                ...
                $.ajax({
                    method: 'post',
                    url: '{{ route('trademark.delete.post') }}',
                    data: {
                        'ids': id,
                        '_token': '{{ csrf_token() }}',
                    },
